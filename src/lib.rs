...
#[derive(Debug)]
pub struct TapeDriftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TapeDriftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TapeDrift processing");
    
    let mut processor = TapeDriftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TapeDriftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TapeDriftProcessor::new(false);
